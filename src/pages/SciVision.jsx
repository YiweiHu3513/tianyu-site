    ...
    <>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-6xl px-6 pt-24 pb-16 md:pt-36 md:pb-20">
          <span className="text-xs font-bold tracking-widest uppercase text-teal">PLATFORM</span>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-ink mt-2 mb-6">
            一站式科学传播视觉资产AI平台
          </h1>
      ...
      <section className="bg-white/50 border-t border-line">
        <div className="mx-auto max-w-6xl px-6 py-20">
          <h2 className="text-3xl font-bold text-ink mb-3">四大核心功能</h2>
          <p className="text-muted mb-12">从文本到图像，全流程智能化支持</p>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {FEATURES.map((f) => (
              <div key={f.title} className="rounded-2xl border border-line bg-card overflow-hidden hover:shadow-lg hover:-translate-y-1 transition-all">
      ...
      <section>
        <div className="mx-auto max-w-6xl px-6 py-20">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold text-ink mb-4">科学视觉生成器</h2>
      ...
      <section className="bg-white/50 border-t border-line">
        <div className="mx-auto max-w-6xl px-6 py-20">
          <h2 className="text-3xl font-bold text-ink mb-3">视觉语法的科学基础</h2>
          <p className="text-muted mb-12">不仅仅是画得好看，更是画得对</p>
          <div className="grid md:grid-cols-3 gap-6">
            {CAPABILITIES.map((c) => (
              <div key={c.title} className="rounded-2xl border border-line bg-card overflow-hidden">
      ...
      <section>
        <div className="mx-auto max-w-6xl px-6 py-20">
          <h2 className="text-3xl font-bold text-ink mb-3">双引擎协同生成</h2>
          <p className="text-muted mb-12">AI的高效与艺术家的灵感，共同为您服务</p>
