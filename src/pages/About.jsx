  ...
  return (
    <>
      <section className="mx-auto max-w-6xl px-6 pt-24 pb-16 md:pt-36">
        <p className="text-teal text-xs font-bold tracking-widest uppercase mb-2 scroll-reveal">About Us</p>
        <h1 className="text-4xl md:text-5xl font-extrabold text-ink mb-6 scroll-reveal">关于天与视界</h1>
        <p className="text-lg text-muted max-w-3xl leading-relaxed scroll-reveal">
      ...
      <section className="bg-white/50 border-t border-line">
        <div className="mx-auto max-w-6xl px-6 py-20">
          <h2 className="text-2xl font-bold text-ink mb-2 scroll-reveal">核心创始人</h2>
          <p className="text-muted mb-10 scroll-reveal">学术与艺术的交汇点</p>
          <div className="grid md:grid-cols-3 gap-8">
            {FOUNDERS.map((m) => (
              <div key={m.name} className="scroll-reveal text-center">
      ...
      <section>
        <div className="mx-auto max-w-6xl px-6 py-20">
          <h2 className="text-2xl font-bold text-ink mb-10 scroll-reveal">核心团队</h2>
          <div className="grid md:grid-cols-3 gap-6">
            {TEAM.map((m) => (
              <div key={m.name} className="scroll-reveal p-6 rounded-2xl border border-line bg-card card-elevated">
