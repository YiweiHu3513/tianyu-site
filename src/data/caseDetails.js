...
const CASE_DETAILS = {
  ...
  'energy-civilization': {
    ...
    tags: ['核聚变', '美术馆', '科普展览'],
    intro:
      '国内首个以"可控核聚变"为主题的美术馆级科学艺术展览，汇聚核聚变领域的顶级科学家与艺术界领军人物。通过历史、科学和艺术三个维度的知识图谱构建，全面展示核聚变科学原理。展览包含巨型装置作品《闪电》（致敬特斯拉线圈）、《海》（50吨人造海水）、《造太阳》（直径5米的人造太阳装置），以及首部AI核聚变影像《遥远太阳之歌》。中央美术学院、合肥综合性国家科学中心能源研究院与合肥市人民政府联合推出。2025年9月14日至10月12日，中央美术学院美术馆一层。',
    links: [
      ...
      { label: '策展深度解读', url: 'https://mp.weixin.qq.com/s/G1vToh6RJcxUJqi5jK8K1Q' },
    ],
    chapters: [
      {
        num: 'I',
